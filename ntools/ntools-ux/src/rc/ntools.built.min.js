...
define("nmodule/ntools/rc/GMapsWidget","baja! baja!baja:IStatus bajaux/Widget bajaux/mixin/subscriberMixIn jquery Promise underscore hbs!nmodule/ntools/rc/GMapsWidgetTemplate hbs!nmodule/ntools/rc/PopupTemplate lex!ntools css!nmodule/ntools/rc/GMapsWidgetStyle".split(" "),function(k,e,g,a,d,m,f,b,c,s){function p(a){a=a.split(",");return{lat:parseFloat(1<a.length?a[0].trim():0),lng:parseFloat(1<a.length?a[1].trim():0)}}function q(a){return a.getType().is("baja:IStatus")&&(a=k.Status.getStatusFromIStatus(a))&&
...
display:r.get("display")};b.getSlots().flags(k.Flags.SUMMARY).each(function(d){a.rows=a.rows||[];a.rows.push({displayName:b.getDisplayName(d),value:b.getDisplay(d)||b.get(d)})});n.setContent(c(a))}};l.call(b);n.open(d,g);a.getSubscriber().attach("changed",l)});h.event.addListener(n,"closeclick",function(){a.getSubscriber().detach("changed",l)})}var u="/module/ntools/rc/map_good.png",t="/module/ntools/rc/map_alarm.gif",r=s[0];e=function(){g.apply(this,arguments);this.properties().add("position","43.077814,-85.609354").add("zoom",
14).add("key","AIzaSyAXEgPoEs_zq9XwI_M4HghSed4ABiluXYQ");a(this)};e.prototype=new g;e.prototype.constructor=e;e.prototype.doInitialize=function(a){var c,h=this,e;a.addClass("gMapsWidget");c=d("\x3ciframe class\x3d'gMapsWidget' src\x3d'about:blank' /\x3e");a.append(c);e=c.get(0).contentWindow;return(new m(function(a,d){var c=e.document;c.open("text/html","replace");c.write(b({key:h.properties().getValue("key")}));c.close();e.addEventListener("message",function(b){"googleMapsLoaded"===b.data&&a()},
!1)})).then(function(){return new m(function(a,b){d(e).ready(function(){h.$gmaps=e.google.maps;a()})})}).then(function(){var a=e.document.getElementById("map-canvas"),b=p(h.properties().getValue("position")),c=h.properties().getValue("zoom");h.$map=new h.$gmaps.Map(a,{zoom:c,center:{lat:b.lat,lng:b.lng}})})};e.prototype.doLoad=function(a){var b=this;return a.cursor().then(function(a){var b=[];a.each(function(){b.push(this.get())});return b}).then(function(a){return m.all(f.map(a,function(a){return a.tags()}))}).then(function(a){a=
f.filter(a,function(a){return a.contains("n:ordInSession")&&a.contains("n:geoCoord")});a=f.map(a,function(a){return a.get("n:ordInSession")});return(new k.BatchResolve(a)).resolve({subscriber:b.getSubscriber()})}).then(function(a){a=a.getTargetObjects();f.each(a,function(a){v(b,a)})})};e.prototype.doDestroy=function(){this.jq().removeClass("gMapsWidget")};return e});