...
/* START_TEMPLATE */
define('hbs!nmodule/ntools/rc/GMapsWidgetTemplate',['Handlebars'], function( Handlebars ){ 
...
Handlebars.registerPartial('nmodule/ntools/rc/GMapsWidgetTemplate', t);
return t;
});
/* END_TEMPLATE */
;
/* START_TEMPLATE */
define('hbs!nmodule/ntools/rc/PopupTemplate',['Handlebars'], function( Handlebars ){ 
var t = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper;
...
Handlebars.registerPartial('nmodule/ntools/rc/PopupTemplate', t);
return t;
});
/* END_TEMPLATE */
;
 ...
 */
define('nmodule/ntools/rc/GMapsWidget',['baja!',
        'baja!baja:IStatus',
        'bajaux/Widget',
        ...
        'Promise',
        'underscore',
        'hbs!nmodule/ntools/rc/GMapsWidgetTemplate',
        'hbs!nmodule/ntools/rc/PopupTemplate',
        'lex!ntools',
        'css!nmodule/ntools/rc/GMapsWidgetStyle'], function (
        baja,
        types,
        Widget,
        subscriberMixIn,
  ...
  var GMAPS_CLASS = "gMapsWidget",
      OK_IMAGE_URI = '/module/ntools/rc/map_isgood.png',
      ALARM_IMAGE_URI = '/module/ntools/rc/map_inalarm.gif',
      DOWN_IMAGE_URI = '/module/ntools/rc/map_isdown.gif',
      LEX = lexicons[0];
